...
var SEED_DATA = [
  ...
  },
  {
    ...
    category: 'secondhand',
    lat: 38.54262, lng: -121.74922,
    geocodeAddress: 'Memorial Union, 1 Shields Ave, Davis, CA 95616',
    address: 'Memorial Union, 1 Shields Ave #154, Davis, CA 95616',
    link: 'https://aggiereuse.ucdavis.edu/',
    description: 'zero-cost secondhand store run by UC Davis students - clothing, school supplies, small appliances, all free to take. open to the wider Davis community, not just students. closes for the summer; check their site before visiting.',
    source: 'researched',
    tags: ['free', 'student-run'],
    lastVerified: '2026-06-22'
  },
  {
    id: 'zw7',
  ...
  },
  {
    ...
    category: 'food',
    lat: 38.54520, lng: -121.74420,
    geocodeAddress: 'Central Park, 4th St & C St, Davis, CA 95616',
    address: 'Davis Farmers Market, 4th & C St, Davis, CA 95616',
    link: 'https://www.daviswiki.org/Uppercrrust_Bakery',
    description: 'beloved Davis bakery with a stand at the farmers market. bring a mesh bag, pillowcase, or cloth bag - they\'ll put your loaf or pastries directly into it so you skip the paper bag entirely. one of the easiest zero waste swaps at the market.',
    personalNote: "heads up: this only covers baked goods. if you order a drink for here, hot drinks come in real glassware, but a cold drink still comes in a plastic to-go cup even if you're staying to drink it - found that out ordering an iced one.",
    source: 'researched',
    tags: ['community'],
    lastVerified: '2026-06-22'
  },
  ...
  },
  {
    ...
    name: "Peet's Coffee",
    category: 'cafe',
    lat: 38.5610, lng: -121.7588,
    geocodeAddress: '1411 W Covell Blvd, Davis, CA 95616',
    address: '1411 W Covell Blvd, Davis, CA 95616',
    link: 'https://www.peets.com/pages/store/davis',
    description: 'west Davis location of the coffee chain. like most Peet\'s locations, they\'ll fill your own cup or mug instead of using a fresh disposable one.',
    source: 'researched',
    lastVerified: '2026-07-05'
  },
  {
    ...
    category: 'swap',
    lat: 38.5486, lng: -121.7168,
    geocodeAddress: '2222 E 8th St, Davis, CA 95618',
    address: '2222 E 8th St, Davis, CA 95618',
    link: 'https://littlefreelibrary.org/map/',
    description: 'a small, open-24/7 book box on a front lawn - take a book, leave a book, no card or account needed. easy to walk past without registering it as a real zero waste habit, but every book taken here is one that didn\'t get bought new or shipped.',
    personalNote: "this is one of several little free libraries scattered around davis, not the only one. the official map link above will show whichever ones are closest to wherever you're starting from.",
    source: 'researched',
    tags: ['free', 'volunteer-run'],
    lastVerified: '2026-07-05'
  }
